                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="submit" name="tambahp" class="btn mb-2 btn-primary">Tambah</button>
                                            </div>
                                            </form>
                                        </div>
                                    </div>
                                            ...
                                            <tr>
                                                ...
                                                <td><button class="btn btn-sm dropdown-toggle more-horizontal"
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <a class="dropdown-item" href="#" data-toggle="modal" data-target="#editModal<?=$data['id_pelanggan'];?>">Edit</a>
                                                        <a class="dropdown-item" href="#" data-toggle="modal" data-target="#hapusModal<?=$data['id_pelanggan'];?>">Remove</a>
                                                    </div>
                                                </td>
                                            </tr>
                                            <!-- Modal Edit -->
<div class="modal fade" id="editModal<?=$data['id_pelanggan'];?>" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <form method="post">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label>Nama</label>
                        <input type="text" name="nama" class="form-control" value="<?=$nama_pelanggan;?>">
                    </div>
                    <div class="form-group">
                        <label>No Telp</label>
                        <input type="text" name="no" class="form-control" value="<?=$notelp;?>">
                    </div>
                    <div class="form-group">
                        <label>Alamat</label>
                ...
                <div class="modal-footer">
                    <button type="submit" name="editpelanggan" class="btn btn-primary">Simpan</button>
                </div>
            </div>
        </form>
    </div>
...
<!-- Modal Hapus -->
<div class="modal fade" id="hapusModal<?=$data['id_pelanggan'];?>" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <form method="post">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <input type="hidden" name="id_pelanggan" value="<?=$data['id_pelanggan'];?>">
                    <p>Yakin ingin menghapus pelanggan <strong><?=$nama_pelanggan;?></strong>?</p>
                </div>
                <div class="modal-footer">
